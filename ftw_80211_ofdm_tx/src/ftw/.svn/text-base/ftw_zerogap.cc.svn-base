...
{
  return ftw_zerogap_sptr(new ftw_zerogap(symbol_length, N_symbols, zerogap));
}

ftw_zerogap::ftw_zerogap(int symbol_length, int N_symbols,
...
ftw_zerogap::~ftw_zerogap(){}

int ftw_zerogap::general_work (int noutput_items,
...
void ftw_zerogap::enter_idle(){
  d_state = ST_IDLE;
  d_nsymbols_output = 0;
  d_pending_flag = 0;
}

void ftw_zerogap::enter_first_payload_and_zerogap(){
